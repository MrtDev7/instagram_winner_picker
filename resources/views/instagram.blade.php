            ...
            <div class="row justify-content-md-center text-center">
                <div class="col-md-8 col-lg-8">
                    <div class="banner_title margin-b-2 align-content-center">
                        ...
                        <div class="picker-container bg-white ">
                            <div id="search-area">
                                ...
                                <br>
                                <input id="scanner-text" type="text"
                                       value="https://www.instagram.com/p/CJ_Oa_Vn7_C/"
                                       class="form-control outline margin-b-1"
                                       style="box-shadow: none !important;
                                                                                                                                border-color: #165df5;height: 55px; border-radius: 100px"
                                       placeholder="ex. https://www.instagram.com/p/POSTID/">
                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <input type="number"
                                                   style="text-align: center;width: 75px;padding-left: 8px;border-radius: 15px;color: #127fad;height: 30px;border: 1px solid #127fad;"
                                                   id="comment-count" min="1" value="100">
                                        </div>
                                    </div>
                                </div>
                                <br>
                                <button onclick="getComments()" type="button" style="width: 120px"
                                        class="btn scale rounded-pill btn-video btn_video">
                                    {{ __('main.scan') }}
                                </button>
                            </div>
                            <div id="comments-area" style="display: none">
                                            ...
                                            <div class="container-fluid">
                                                <div class="row">
                                                    <div class="col-8"><label
                                                            style="font-size: 15px">{{ __('main.number_of_minimum_mention') }}</label>
                                                    </div>
                                                    <div class="col-4"><input type="number"
                                                                              style="text-align: center;width: 75px;padding-left: 8px;border-radius: 15px;color: #127fad;height: 30px;border: 1px solid #127fad;"
                                                                              id="min-mention" min="1" max="20"
                                                                              value="1"></div>
                                                    <div class="col-8"><label
                                                            style="font-size: 15px">{{ __('main.number_of_winners') }}</label>
                                                    </div>
                                                    <div class="col-4"><input type="number" id="winner" min="1"
                                                                              max="20" value="1"
                                                                              style="text-align: center;width: 75px;padding-left: 8px;border-radius: 15px;color: #127fad;height: 30px;border: 1px solid #127fad;">
                                                    </div>
                                                </div>
                                ...
                                <br>
                                <br>
                                <button onclick="findWinners()" type="button" style="width: 200px;"
                                        class="btn scale rounded-pill btn-video btn_video">
